...
const RoomsListItem: FC<RoomsListItemProps> = observer(({ room }) => {
  ...
  return (
    <li className="border-bottom">
      <button
        // aria-current="page"
        // to={`/chat/${userState.auth.userId}/${room._id}`}
        // disabled={roomState.chatId === room._id}
        className={`p-2 ${styles.RoomListBtnLink} ${
          roomState.chatId === room._id ? styles.RoomListBtnLinkActive : ""
        }`}
